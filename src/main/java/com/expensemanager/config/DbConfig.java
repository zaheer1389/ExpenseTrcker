...
public class DbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emf.setPackagesToScan("com.expensemanager");
    ...
    public DataSource dataSource() {
        ...
        try {
			dataSource.getConnection().createStatement().executeQuery("SET GLOBAL sql_mode=(SELECT REPLACE(@@sql_mode,'ONLY_FULL_GROUP_BY',''))");
		} catch (Exception e) {
